...
import { BookOpen, Shield, Zap, ArrowRight, User as UserIcon, Lock, Sparkles } from 'lucide-react';
    ...
    <div className="min-h-screen w-full flex items-center justify-center bg-[var(--bg-primary)] px-4 py-12 relative overflow-hidden">
      ...
      >
        <div className="text-center mb-12">
          ...
          >
            Intelligence beyond the document.
          </motion.p>
        </div>
        ...
        >
          ...
          <button
            ...
            className="mt-4 w-full border border-dashed border-stone-300 text-stone-500 py-3 rounded-xl hover:border-brand/30 hover:text-brand/80 hover:bg-[var(--bg-elevated)] transition-all text-xs font-medium flex items-center justify-center gap-2 group"
          >
        ...
        >
          New to Noetix?{' '}
          <Link to="/register" className="text-brand hover:text-brand/80 font-medium ml-1 transition-colors">
            Create an account
          </Link>
        </motion.p>
      </motion.div>
